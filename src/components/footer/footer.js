                  ...
                  <div className="col-md-3 col-sm-6 col-xs-12 widget sm-margin-30px-bottom">
                      ...
                      <ul className="latest-post position-relative top-3">
                          ...
                          <li>
                              ...
                              <div className="text-small"><a href="blog-post-layout-03.html">I love making the stuff, thats...</a> <span className="clearfix"></span>20 April 2017 | by <a href="blog-grid.html">Herman Miller</a></div>
                          </li>
                      </ul>
                  </div>
                  {/* end blog post */}
      ...
      <div className="container">
          <div className="footer-bottom border-top border-color-medium-dark-gray padding-30px-top">
              <div className="row">
                  ...
                  <div className="col-md-6 col-sm-6 col-xs-12 text-right text-small xs-text-center">&COPY; 2017 POFO is Proudly Powered by <a href="http://www.themezaa.com" target="_blank" title="ThemeZaa" rel="noopener noreferrer">ThemeZaa</a></div>
                  {/* end copyright */}
              </div>
          </div>
      </div>
